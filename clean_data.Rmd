  ...
  # the variable that will go on the x axis.
    ...
    # Make the poverty rate model's output
      ...
      pov_model <- ozlist %>% 
        ...
        # At first, I included state as another predictor. I saw that the trends
        # were largely the same across states. Given that, it would only be
        # confusing to show the trend for each state on the same graph. However,
        # if I include state as a predictor and do not plot each state's trend
        # separately, it is harder to see the trends for the whole set of
        # states. That's why I just removed state as a predictor in the end.
...
saveRDS(all_objects_for_rds, "all_objects.rds")
```
