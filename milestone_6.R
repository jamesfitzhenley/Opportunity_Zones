...
# Create a new observation tibble with each 0.01 value for each state for variable
  # Should be referenced in the var_names tibble
...
#                                 rep("South Carolina", 101), rep("Georgia", 101),
#                                 rep("Tennessee", 101), rep("Mississippi", 101)))
# inc_new_obs <- tibble(medhhincome2014_tract = rep(seq(0, 1, 0.01), 6),
#                       state = c(rep("Alabama", 101), rep("North Carolina", 101),
#                                 rep("South Carolina", 101), rep("Georgia", 101),
#                                 rep("Tennessee", 101), rep("Mississippi", 101)))
